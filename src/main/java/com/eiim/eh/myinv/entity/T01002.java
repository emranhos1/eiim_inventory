...
public class T01002 {
    ...
    @Column(name = "t_vendor_first_name")
    private String vendorFirstName;
    @Column(name = "t_vendor_last_name")
    private String vendorLastName;
    @Column(name = "t_vendor_business_name")
    private String vendorBusinessName;
    @Column(name = "t_vendor_email")
    private String vendorEmail;
    @Column(name = "t_vendor_phone_no")
    private String vendorPhoneNo;
    @Column(name = "t_vendor_address")
